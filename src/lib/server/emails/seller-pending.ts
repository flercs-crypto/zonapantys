...
export const buildSellerPendingEmail = ({
	...
	const body = `
		<p style="margin: 24px 0 0; color: #0f172a; font-size: 16px; line-height: 1.8;">Hola ${escapeHtml(sellerName)}, recibimos tu registro de vendedora y tu perfil ya entró en revisión manual.</p>
		<div style="margin-top: 22px; border: 1px solid #e2e8f0; background: #ffffff; border-radius: 18px; padding: 22px 24px;">
			<p style="margin: 0 0 14px; color: #0f172a; font-size: 14px; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;">Qué sigue ahora</p>
		...
		<p style="margin: 20px 0 0; color: #475569; font-size: 14px; line-height: 1.8;">Si necesitas ayuda, visita nuestro centro de soporte: <a href="${helpHref}" style="color: #b54913; font-weight: 700; text-decoration: none;">${helpHref}</a>.</p>`;
