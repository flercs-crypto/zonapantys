...
export const buildSellerApprovedEmail = ({
	...
	const body = `
		<p style="margin: 24px 0 0; color: #0f172a; font-size: 16px; line-height: 1.8;">Hola ${escapeHtml(sellerName)}, tu perfil fue aprobado y tu tienda ya puede aparecer públicamente en ZonaPantys.</p>
